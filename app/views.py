...
class ProductView(View):
	def get(self, request):
		...
		return render(request, 'app/home.html', {'topwears':topwears, 'laptops':laptops,'bottomwears':bottomwears, 'mobiles':mobiles, 'totalitem':totalitem})
...
def mobile(request, data=None):
	...
	if data==None :
			mobiles = Product.objects.filter(category='M')
	elif data == 'Redmi' or data == 'Samsung' or data == 'Poco' or data == 'iphone' or data == 'Realme':
...
def laptop(request, data=None):
	...
	if data==None :
			laptops = Product.objects.filter(category='L')
	elif data == 'Asus' or data == 'Acer' or data == 'MSI' or data == 'Dell' or data == 'Lenovo':
...
def bottomware(request, data=None):
	...
	elif data == 'AllenSolly' or data == 'Gucci' or data == 'Zara':
			bottomwares = Product.objects.filter(category='BW').filter(brand=data)
	elif data == 'below':
			bottomwares = Product.objects.filter(category='BW').filter(discounted_price__lt=500)
	elif data == 'above':
			bottomwares = Product.objects.filter(category='BW').filter(discounted_price__gt=500)
	return render(request, 'app/bottomware.html', {'bottomwares':bottomwares, 'totalitem':totalitem})
